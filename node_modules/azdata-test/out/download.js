...
exports.downloadAndUnzipAzureDataStudio = void 0;
...
var adsTestDir = path.resolve(extensionRoot, '.ads-test');
var azureDataStudioStableReleasesAPI = "https://azuredatastudio-update.azurewebsites.net/api/releases/stable";
function fetchLatestStableVersion() {
    return __awaiter(this, void 0, void 0, function () {
        var versions;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.getJSON(azureDataStudioStableReleasesAPI)];
                case 1:
                    versions = _a.sent();
 ...
 */
function downloadAzureDataStudioArchive(version, platform) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var downloadUrl = util_1.getAzureDataStudioDownloadUrl(version, platform);
                    ...
                    https.get(requestOptions, function (res) {
                        ...
                        if (archiveUrl.endsWith('.zip')) {
                            var archivePath_1 = path.resolve(adsTestDir, "ads-" + version + ".zip");
                            ...
                            var zipPath_1 = path.resolve(adsTestDir, "ads-" + version + ".tgz");
 ...
 */
function unzipAzureDataStudio(azureDataStudioArchivePath) {
    // The 'ads-1.32' out of '.../ads-1.32.zip'
    var dirName = path.parse(azureDataStudioArchivePath).name;
    var extractDir = path.resolve(adsTestDir, dirName);
    var res;
 ...
 */
function downloadAndUnzipAzureDataStudio(version, platform) {
    return __awaiter(this, void 0, void 0, function () {
        var downloadedPath, _a, currentHash, currentDate, _b, latestHash, latestTimestamp, err_1, azureDataStudioArchivePath, err_2;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [3 /*break*/, 4];
                case 2:
                    if (!!fs.existsSync(path.resolve(adsTestDir, "ads-" + version))) return [3 /*break*/, 4];
                ...
                case 7:
                    ...
                    downloadedPath = path.resolve(adsTestDir, "ads-" + version);
                ...
                case 14:
                    ...
                    return [4 /*yield*/, downloadAzureDataStudioArchive(version, platform)];
                case 15:
                    azureDataStudioArchivePath = _c.sent();
                ...
                case 17:
                    if (version === 'insiders') {
                        return [2 /*return*/, Promise.resolve(util_1.insidersDownloadDirToExecutablePath(path.resolve(adsTestDir, "ads-" + version)))];
                    }
                    else {
                        return [2 /*return*/, util_1.downloadDirToExecutablePath(path.resolve(adsTestDir, "ads-" + version))];
                    }
                    return [2 /*return*/];
            }
        });
...
exports.downloadAndUnzipAzureDataStudio = downloadAndUnzipAzureDataStudio;
