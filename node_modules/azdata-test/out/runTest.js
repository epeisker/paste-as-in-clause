...
function runTests(options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!!options.azureDataStudioExecutablePath) return [3 /*break*/, 2];
                    _a = options;
                    return [4 /*yield*/, download_1.downloadAndUnzipAzureDataStudio(options.version, options.platform)];
                case 1:
                    _a.azureDataStudioExecutablePath = _b.sent();
                    _b.label = 2;
                case 2:
                    args = [
                    ...
                    return [2 /*return*/, innerRunTests(options.azureDataStudioExecutablePath, args, options.extensionTestsEnv)];
            }
        });
    });
}
