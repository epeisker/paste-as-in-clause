...
exports.resolveCliPathFromAzureDataStudioExecutablePath = exports.getLatestInsidersMetadata = exports.insidersDownloadDirMetadata = exports.insidersDownloadDirToExecutablePath = exports.downloadDirToExecutablePath = exports.urlToOptions = exports.getAzureDataStudioDownloadUrl = exports.systemDefaultPlatform = void 0;
...
switch (process.platform) {
    case 'darwin':
        ...
        break;
    case 'win32':
        exports.systemDefaultPlatform = 'win32-x64-archive';
        break;
    default:
        exports.systemDefaultPlatform = 'linux-x64';
}
function getAzureDataStudioDownloadUrl(version, platform) {
...
exports.getAzureDataStudioDownloadUrl = getAzureDataStudioDownloadUrl;
...
function getLatestInsidersMetadata(platform) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    remoteUrl = "https://azuredatastudio-update.azurewebsites.net/api/update/" + platform + "/insider/latest";
 ...
 */
function resolveCliPathFromAzureDataStudioExecutablePath(azureDataStudioExecutablePath) {
    if (process.platform === 'win32') {
...
exports.resolveCliPathFromAzureDataStudioExecutablePath = resolveCliPathFromAzureDataStudioExecutablePath;
